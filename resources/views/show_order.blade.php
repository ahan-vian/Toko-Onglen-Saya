                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 border-b pb-4">
                        ...
                        <div class="mt-4 md:mt-0 flex items-center gap-3">
                            ...
                            @if ($order->is_paid)
                                <a href="{{ route('print_invoice', $order->id) }}" target="_blank" 
                                   class="bg-gray-800 hover:bg-gray-900 text-white text-sm font-medium px-4 py-2 rounded-md shadow-sm flex items-center gap-2 transition-colors">
                                    <svg xmlns="http://www.apache.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
