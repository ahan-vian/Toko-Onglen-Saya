            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 flex flex-col md:flex-row gap-8">
                    ...
                    <div class="w-full md:w-1/2 flex flex-col justify-start">
                        ...
                        <p class="text-3xl text-blue-600 font-bold mb-6">Rp {{ number_format($product->price, 0, ',', '.') }}</p>
                        
                        <div class="mb-6">
                            <span class="bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-bold border border-green-300">
                        ...
                        <div class="mt-auto">
                            <a href="{{ route('show_product') }}" class="inline-block bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-6 rounded transition-colors">
